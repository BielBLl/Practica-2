...
proporciones_problemas$CuerpoDocente <- factor(proporciones_problemas$CuerpoDocente, 
    levels = c("1.Infantil", "2.Primaria", "3.Secundaria/Bachiller", "4.Universidad", "5.Formación Profesional", "6.Regimen Especial", "7.Música/Artes Escénicas"))

proporciones_problemas <- proporciones_problemas %>% arrange(CuerpoDocente)
proporciones_problemas_seleccionado <- proporciones_problemas %>%
  select("CuerpoDocente","Proporcion:Si", "Proporcion:No")
# Mostrar las proporciones
proporciones_problemas_seleccionado
```
