...
unique(sub_data_limpia$data.cuerpo_docente)
```
...
datas = data_frame(dades$Cos.docent, dades$Ha.estat.diagnosticat.per.un.especialista.mèdic..otorinolaringòleg..foniatra..d.alguna.lesió.a.les.cordes.vocals.)

colnames(datas)= c("Cos.docent", "Diagnosticat")

mestres = c("Educació Infantil","Educació Primària", "Educació Secundària", "Formació Professional", "Universitat")

datas = datas[datas$Cos.docent %in% mestres ,]

as.data.frame(table(datas))
